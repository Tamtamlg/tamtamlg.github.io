...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      js: {
        src: [
          'build/js/request.js', 'build/js/masonry.pkgd.min.js', 'build/js/jquery-imagefill.js', 'build/js/imagesloaded.pkgd.min.js', 'build/js/eventListener.polyfill.js'
        ],
