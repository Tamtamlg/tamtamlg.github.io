  ...
  create: function() {
    ...
    switch (answerCode) {
      ...
      case "011001":
        zag = "ГУ. Исправление";
        wtt =
          "Вам надлежит исправить какоето зло, возродить утраченное, устранить недопонимание. Не жалейте энергии. Быть может, вы сумеете сделать больше, чем рассчитываете. Думайте и поступайте правильно. Вы можете смело продвигаться по намеченному пути, даже если это грозит вам разладом с друзьями.";
        break;
      case "110000":
        zag = "ЛИНЬ. Посещение";
        wtt =
          " После успешного начала вам надо приспосабливаться к новым обстоятельствам. Завоевав авторитет, благодаря настойчивости, вы затем проявляйте сдержанность, осторожность, мудрость, великодушие и даже щедрость. Каждый этап вашего пути посвоему прекрасен.";
        break;
      case "000011":
      ...
      case "001010":
        ...
        wtt =
          "Не стоит оплакивать свою судьбу, когда перед вами вырастает препятствие - лучше постарайтесь устранить или обойти его. В чрезвычайной ситуации действуйте решительно. Даже сужающаяся тропинка кудато ведет. Ищите помощи у других и оказывайте ее сами, когда у вас ее просят. Помните: препятствие, стоящее на пути у другого, через некоторое время может возникнуть перед вами.";
        break;
      case "010100":
        zag = "ЦЗЕ. Разрешение";
        wtt =
          "Та самая гроза, которая заставила вас искать укрытие, освежила воздух и позволила вам с новыми силами двинуться в путь после того, как она утихла. Но если вы захотите быстрее достичь цели, вам придется освободиться от прежних привяэанностей или попутчиков, которые могут помешать вам наверстать упущенное.";
        break;
      case "110001":
        zag = "СУНЬ. Убыль";
        wtt =
      ...
      case "000110":
        ...
        wtt =
          "Тяжело плыть против течения. Беспокойные и настырные первыми отправляются в путь и часто возвращаются обратно. Для того чтобы достичь цели, лучше всего выждать прилива и отдаться на волю волн вместе с другими. Если же окружающие не проявляют интереса к плаванию, возьмите с собой хоть когонибудь и постарайтесь оказаться на гребне приливной волны.";
        break;
      case "011000":
        zag = "ШЭН. Подъем";
        wtt =
      ...
      case "010110":
        zag = "КУНЬ. Истощение";
        wtt =
          " Когда вас преследует неудача, может возникнуть желание убежать как можно дальше и заняться чемто совершенно новым. Получше присмотритесь к себе. Ведь неудачи оказываются полезными для некоторых людей, в основном для тех, кто умеет преодолевать трудности и из испытаний выходит умудренный опы­том. Не стоит биться головой об стену и винить в этом все ту же стену. Напротив, верьте в себя и помните: вы разорвете путы, которые мешают вам действовать, как только вернутся силы.";
        break;
      case "011010":
        zag = "ЦЗИН. Колодец";
        wtt =
      ...
      case "101100":
        zag = "ФЭН. Изобилие";
        wtt =
          "Когда вы счастливы, озаряйте жизнь окружающих подобно тому, как полуденное солнце озаряет землю. Если же небо над вами потемнеет, не беспокойтесь; не пугайтесь, если даже проглянут звезды. Это всего лишь означает, что егозалуна ненадолго заслонила ваше солнце. Она уйдет так же быстро, как и появилась. А свет солнца засияет для вас еще ярче.";
        break;
      case "001101":
        zag = "ЛЮЙ. Странствие";
        wtt =
